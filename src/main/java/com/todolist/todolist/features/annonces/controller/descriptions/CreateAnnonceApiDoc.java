...
@Operation(
        ...
        description = "Crée une nouvelle annonce. L'auteur et la catégorie doivent exister."
)
@ApiResponses({
        @ApiResponse(
                responseCode = "201",
        ...
        @ApiResponse(responseCode = "404", description = "Auteur ou catégorie introuvable", content = @Content),
        @ApiResponse(responseCode = "500", description = "Erreur interne du serveur", content = @Content)
})
public @interface CreateAnnonceApiDoc {
}